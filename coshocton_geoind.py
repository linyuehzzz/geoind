...
with open('data/coshocton/sols/coshocton_runtime.csv', 'w', newline='') as fw:
    ...
    for eps in eps_all:
        for k_neighbors in k_neighbors_all:
            ...
            with open('data/coshocton/sols/coshocton_prob_eps' + str(eps) + "_k" + str(k_neighbors-1) + '.csv', 'w', newline='') as f1:
                wr1 = csv.writer(f1)
                with open('data/coshocton/sols/coshocton_prob_obj_eps' + str(eps) + "_k" + str(k_neighbors-1) + '.csv', 'w', newline='') as f2:
                    wr2 = csv.writer(f2)
